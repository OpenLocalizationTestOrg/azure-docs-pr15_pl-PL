<properties 
    pageTitle="Za pomocą łączników zapasu czasu w aplikacjach logiczny | Microsoft Azure aplikacji usługi"
    description="Jak utworzyć i skonfigurować aplikację łącznika zapas czasu lub interfejsu API i używać go w aplikacji dla logiki Azure aplikacji usługi"
    authors="msftman" 
    manager="erikre" 
    editor="" 
    services="logic-apps" 
...
# <a name="weve-improved-the-slack-connector"></a>Firma Microsoft została ulepszona zapasu czasu łącznika 
...
- [Dowiedz się więcej na temat tego nowego łącznika](../connectors/connectors-create-api-slack.md)
