...
Poniższa lista kontrolna konfiguracji wdrażania informacje potrzebne do zebrania przed oraz jak skonfigurować oprogramowanie na urządzeniu StorSimple. Przygotowywanie niektóre z tych informacji wyprzedzeniem pomoże usprawnienie procesu wdrażania urządzenia StorSimple w środowisku. Ta lista kontrolna umożliwia również Zanotuj szczegóły konfiguracji, jak wdrożyć urządzenia.

| Etap                                  | Parametr                                         | Szczegóły                                                                                                                                                                | Wartości |
|----------------------------------------|---------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| **Kabel urządzenia**                      | Liczba kolejna programu access                                     | Konfiguracja początkowa urządzenia                                                                  | Tak/nie |
|   |   |  |  |
| **Konfigurowanie i zarejestrować urządzenie**          | Ustawienia sieci danych 0                           | Adres IP danych 0:</br>Maska podsieci:</br>Brama:</br>Podstawowy serwer DNS:</br>Podstawowy serwer NTP:</br>Serwer proxy sieci Web IP/FQDN (opcjonalnie):</br>Port serwera proxy sieci Web:|        |
|                                        | Hasło administratora urządzenia                     | Hasło musi zawierać od 8 do 15 znaków zawierających małe litery, wielkie litery, liczbowe i znaki specjalne. |        |
|                                        | Hasło StorSimple migawkę Manager              | Hasło musi być 14 15 znaków zawierających małe litery, wielkie litery, liczbowe i znaki specjalne.|        |
|                                        | Klucz rejestru usługi                          | Ten klawisz jest generowany z portalem klasyczny Azure.    |        |
|                                        | Klucza szyfrowania danych usługi                       | Ten klucz jest tworzony, gdy urządzenie jest zarejestrowany wraz z usługą Zarządzanie za pomocą programu Windows PowerShell dla StorSimple. Skopiuj ten klucz i zapisz go w bezpiecznym miejscu.|  |
|   |   |  |  |
| **Konfigurowanie pełną urządzeniu minimalne**          | Przyjazną nazwę dla swojego urządzenia                     | To jest opisową nazwę dla urządzenia. |        |
|                                        | Strefa czasowa                                          | Urządzenie będzie używać tej strefie czasowej wszystkie operacje według harmonogramu.  |        |
|                                        | Pomocniczy serwer DNS                              | Jest to wymagane konfiguracja.                                  |        |
|                                        | Sieciowej: Administrator danych 0 stałe adresy IP                                     | Te IP powinny być routingu z Internetem.</br>Kontroler 0 o stałej IP adres:</br>Kontroler 1 stałej IP adres:|
|   |   |  |  |
| **Dodatkowe interfejsu ustawienia sieci**  | Sieciowej: danych 1</br>Włączenie iSCSI nieskonfigurowane bramy.      | Cel: Używany chmury iSCSI/nie</br>Adres IP:</br>Maska podsieci:</br>Brama:|
|                                        | Sieciowej: danych 2</br>Włączenie iSCSI nieskonfigurowane bramy.      | Cel: Używany chmury iSCSI/nie</br>Adres IP:</br>Maska podsieci:</br>Brama:|
|                                        | Sieciowej: danych 3</br>Włączenie iSCSI nieskonfigurowane bramy.      | Cel: Używany chmury iSCSI/nie</br>Adres IP:</br>Maska podsieci:</br>Brama:|
|                                        | Sieciowej: danych 4</br>Włączenie iSCSI nieskonfigurowane bramy.      | Cel: Używany chmury iSCSI/nie</br>Adres IP:</br>Maska podsieci:</br>Brama:|
|                                        | Sieciowej: danych 5</br>Włączenie iSCSI nieskonfigurowane bramy.      | Cel: Używany chmury iSCSI/nie</br>Adres IP:</br>Maska podsieci:</br>Brama:|
|   |   |  |  |
| **Tworzenie kontenera głośności**                      | Nazwa kontenera woluminu:                            | Nazwa kontenera                                                                                                                                                 |        |
|                                        | Konto Azure miejsca do magazynowania:                            | Miejsca do magazynowania klucz nazwy i dostępu do konta skojarzyć z tym kontenerem głośności                                                                                              |        |
|                                        | Klucza szyfrowania magazynu w chmurze:                     | Klucz szyfrowania dla miejsca do magazynowania w każdym kontenerze                                                                                                                           |        |
|   |   |  |  |
| **Tworzenie woluminu**                        | Szczegóły dla każdego woluminu                           | Nazwa woluminu:                                                                                                                                                           |        |
|                                        |                                                   | Rozmiar:                                                                                                                                                                  |        |
|                                        |                                                   | Typ użycia:                                                                                                                                                            |        |
|                                        |                                                   | Nazwa awaryjnego:                                                                                                                                                              |        |
