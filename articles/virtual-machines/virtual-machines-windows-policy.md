<properties
    ...
    description="Jak stosowanie zasad do Azure Menedżera zasobów systemu Windows maszyn wirtualnych"
...
Powyższe zasady łatwo można zmienić scenariuszy, w których może zajść umożliwia dowolny obraz systemu Windows Server w centrum danych, może być używany do wdrażania maszyn wirtualnych z poniżej zmiany
