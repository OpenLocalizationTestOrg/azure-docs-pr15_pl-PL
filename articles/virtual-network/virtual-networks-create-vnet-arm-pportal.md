<properties
   ...
   description="Dowiedz się, jak tworzyć wirtualną sieć za pomocą portalu Azure w imieniu | Menedżer zasobów."
...
# <a name="create-a-virtual-network-using-the-azure-portal"></a>Tworzenie wirtualnych sieci przy użyciu Azure portal
