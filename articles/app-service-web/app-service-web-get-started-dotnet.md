<properties 
    pageTitle="Wdrażanie pierwszego aplikacji sieci web .NET Azure w pięć minut | Microsoft Azure" 
...
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Wdrażanie pierwszego aplikacji sieci web .NET Azure w pięć minut

Ten samouczek ułatwia wdrażanie aplikacji sieci web dla prostych .NET [Azure aplikacji usługi](../app-service/app-service-value-prop-what-is.md).
...
- Wdrażanie kodu programu ASP.NET.
...
## <a name="deploy-an-net-web-app"></a>Wdrażanie aplikacji sieci web programu .NET
...
1. Zmienianie do katalogu roboczego (`CD`) i klonowanie aplikacji próbki.

        git clone https://github.com/Azure-Samples/app-service-web-dotnet-get-started.git

2. Zmień repozytorium aplikacji próbki. 
...
4. Tworzenie zasobów aplikacji usługi aplikacji platformy Azure o nazwie unikatowe aplikacji i użytkownika wdrażania, które skonfigurowano wcześniej. Gdy zostanie wyświetlony monit, określ liczbę odpowiedni region.
    ...
    ![Tworzenie Azure zasobów dla aplikacji sieci web pierwszego platformy Azure](./media/app-service-web-get-started-languages/dotnet-site-create.png)
...
4. Wdrażanie kodu przykładowe Azure aplikacji tak samo push kodu z cyfra. Po wyświetleniu monitu wprowadź hasło, które skonfigurowano wcześniej.
    ...
    ![Kod push aplikacji sieci web pierwszego platformy Azure](./media/app-service-web-get-started-languages/dotnet-git-push.png)

    `git push`nie tylko umieszcza kod w Azure, ale również przywraca wymagane pakiety i tworzy pliki binarne programu ASP.NET. 
...
Dowiedz się, jak tworzyć, opracowywanie i wdrażanie aplikacji sieci web .NET Azure bezpośrednio w programie Visual Studio na [Wdrażanie aplikacji sieci web programu ASP.NET do aplikacji usługi Azure za pomocą programu Visual Studio](web-sites-dotnet-get-started.md).
