<properties
pageTitle="Dodawanie łącznika w programie Excel | Microsoft Azure"
description="Omówienie łącznik programu Excel z parametrami interfejsu API usługi REST"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Wprowadzenie do łącznika w programie Excel

Nie jest obecnie nie łącznik programu Excel w aplikacjach logika. 

## <a name="to-use-excel-data"></a>Aby użyć danych w programie Excel
Dane programu Excel można przechowywać w formacie wartości rozdzielanych przecinkami (CSV) w folderze miejsca do magazynowania, na przykład w [usłudze OneDrive](connectors-create-api-onedrive.md). Za pomocą tego pliku CSV z [pliku płaskie łącznik](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md).
